...
const mentors: Mentor[] = [
  {
    ...
    photo: "/assets/mentors/ajit.jpg",
  },
  {
    name: "Bhaskar Das, Ph.D",
    designation: "Manager, KIIT-Technology Business Incubator",
    photo: "/assets/mentors/bhaskar.jpg",
  },
  {
    name: "Dr. Vikas Hassija",
    designation: "Associate Professor,SCE",
    photo: "/assets/mentors/vikas.jpg",
  },
  {
    name: "Mr. Satyananda Champati Rai",
    designation: "Associate Professor,SCE",
    photo: "/assets/mentors/rai.jpg",
  },
];
    ...
    <section className="py-16 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg italic">Guiding us every step of the way.</p>
        </div>
              ...
              <CardContent className="flex flex-col items-center p-8">
                ...
                <div className="relative mb-6">
                  <div className="w-32 h-32 rounded-full overflow-hidden ring-4 ring-primary/20 group-hover:ring-primary/40 transition-all duration-300">
                    <Image src={mentor.photo} alt={mentor.name} width={128} height={128} className="w-full h-full object-cover" />
                  </div>
                  {/* Subtle glow effect */}
                ...
                <h3 className="text-xl font-bold text-center mb-2 text-foreground">{mentor.name}</h3>
                <p className="text-muted-foreground text-center text-sm">{mentor.designation}</p>
              </CardContent>
            </Card>
          ))}
        </div>
