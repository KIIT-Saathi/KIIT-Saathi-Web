...
const createGroup = async () => {
  ...
  try {
    ...
    toast({ title: "Group Created! 🎉", description: `${groupForm.name} is ready with ${memberCount} member${memberCount !== 1 ? "s" : ""}.` });

    setGroupForm({ name: "", description: "", currency: "₹", members: [{ name: "", rollNumber: "" }] });
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <Badge variant="secondary" className="text-lg px-4 py-2">₹ SplitSaathi</Badge>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Manage hostel bills, fest contributions, trips, and society spending effortlessly. Because friendship shouldn't cost you your peace of mind! 😌
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6"><h3 className="font-semibold text-lg mb-2">🏠 Hostel Life</h3><p className="text-muted-foreground">Room groceries, electricity bills, cleaning supplies, late-night food orders</p></Card>
            <Card className="p-6"><h3 className="font-semibold text-lg mb-2">🎉 Fest & Events</h3><p className="text-muted-foreground">Committee expenses, decoration costs, team meals, celebration parties</p></Card>
            <Card className="p-6"><h3 className="font-semibold text-lg mb-2">✈️ Trips & Outings</h3><p className="text-muted-foreground">Transportation, accommodation, meals, activities, souvenirs</p></Card>
            <Card className="p-6"><h3 className="font-semibold text-lg mb-2">📚 Study Groups</h3><p className="text-muted-foreground">Reference books, printing costs, cafe study sessions, project materials</p></Card>
          </div>
        </div>
      </section>
