...
import { Societies } from "@/lib/societiesLogo";
...
export default function KiitSocietiesPage() {
  const router = useRouter();
  // location handling: when using app router we rely on window.location for hash scroll
  ...
  const societyServices = [
    {
      ...
      emoji: <CalendarIcon className="w-6 h-6 text-white" />,
  ...
  // (shortened) full societies list kept identical to source — import from your data file or paste here
  const kiitSocieties = React.useMemo(() => [
    {
      name: "Fed KIIT",
      section: "fedkiit",
      brief:
        "Fostering innovation and development through hackathons, workshops, and tech-driven projects.",
      category: "Innovation",
      members: "1,200+",
    ...
    },
    {
      ...
      section: "ecell",
      brief:
        "Promoting entrepreneurship through mentorship, startup incubations, and networking.",
    ...
    },
    {
      ...
      section: "usc",
      brief:
        "Uniting students across cultures with leadership programs, global events, and community initiatives.",
      category: "RPA",
      members: "1,500+",
    ...
    },
    {
      ...
      section: "k1000",
      brief:
        "K-1000 is KIIT’s official Research & Development program, empowering 1000 students to pursue cutting-edge research, innovation, and real-world problem-solving across technical and non-technical domains.",
    ...
    },
    {
      ...
      upcomingEvent: {
        title: "Consumer Tech Innovation Summit",
        date: "Coming Soon",
      },
    ...
    },
    {
      ...
      section: "iotlab",
      brief:
        "A student-driven research and development lab focused on Internet of Things, Embedded Systems, AI, and Robotics.",
      category: "Technical",
      members: "200+",
    ...
    },
    {
      ...
      section: "cybervault",
      brief:
        "The official Cybersecurity & Ethical Hacking Society of KIIT, working on CTFs, penetration testing, and security research.",
    ...
    },
    {
      ...
      section: "kitpd2s",
      brief:
        "KIIT’s Power Distribution & Smart Systems research group focusing on smart grids, energy systems, and sustainable power solutions.",
      category: "Research",
      members: "100+",
    ...
    },
    {
      ...
      section: "aisoc",
      brief:
        "Artificial Intelligence Society of KIIT, fostering learning in Machine Learning, Deep Learning, and AI research.",
      category: "AI/ML",
      members: "180+",
    ...
    },
    {
      ...
      section: "mlsa",
      brief:
        "MLSA KIIT Chapter empowering students with workshops, hackathons, and resources on Microsoft technologies and beyond.",
    ...
    },
    {
      ...
      section: "gdg",
      brief:
        "A Google-backed developer community in KIIT, exploring technologies like Android, Firebase, Flutter, and Web Dev.",
      category: "Developer Community",
      members: "300+",
    ...
    },
    {
      ...
      brief:
        "A coding club supported by Coding Ninjas, conducting coding contests, DSA sessions, and interview prep workshops.",
    ...
    },
    {
      ...
      section: "gfg",
      brief:
        "The official GeeksforGeeks student chapter, focusing on coding, problem-solving, and tech interview readiness.",
      category: "Programming",
      members: "200+",
    ...
    },
    {
      ...
      section: "mun",
      brief:
        "The debating and diplomacy society of KIIT, simulating UN committees to hone public speaking and leadership.",
      category: "Debate",
      members: "300+",
    ...
    },
    {
      ...
      section: "qutopia",
      brief:
        "The official Quizzing Society of KIIT, fostering curiosity and knowledge through quizzes.",
      category: "Quiz",
      members: "250+",
    ...
    },
    {
      ...
      section: "korus",
      brief:
        "The Music & Dance Society of KIIT, nurturing talent through rhythm and performance.",
      category: "Cultural",
      members: "500+",
    ...
    },
    {
      ...
      section: "kalliope",
      brief:
        "The official literary and public speaking society of KIIT, dedicated to eloquence, debate, and the art of words.",
    ...
    },
    {
      ...
      section: "kronicle",
      brief:
        "The official literary and debating society of KIIT, fostering skills in argumentation, conflict, and convincing discourse.",
    ...
    },
    {
      ...
      section: "khwaab",
      brief:
        "The official Social Service Society of KIIT, inspired by the 'Art of Giving', focusing on rural development and humanitarian work.",
    ...
    },
    {
      ...
      section: "automobile",
      brief:
        "Automobile engineering enthusiasts building vehicles and exploring automotive technologies.",
    ...
    },
    {
      ...
      section: "apogeio",
      brief:
        "The Aeronautical Society of KIIT, working on aerospace technology and innovation.",
      category: "Engineering",
      members: "300+",
    ...
    },
    {
      ...
      section: "robotics",
      brief:
        "The official Robotics Society of KIIT, pioneering automation, AI, and robotics projects.",
      category: "Engineering",
      members: "600+",
...

    {
      ...
      section: "keurig",
      brief:
        "The official Cooking Society of KIIT, celebrating culinary arts and food culture.",
      category: "Food",
      members: "450+",
    ...
    },
    {
      ...
      section: "kreativeeye",
      brief:
        "Photography and Painting Society capturing moments and imagination through art.",
      category: "Arts",
      members: "600+",
    ...
    },
    {
      ...
      section: "kartavya",
      brief:
        "Social Responsibility Cell engaging students in social service and awareness programs.",
      category: "Social",
      members: "400+",
    ...
    },
    {
      ...
      section: "kamakshi",
      brief:
        "The Women’s Society of KIIT, working towards empowerment and equality.",
      category: "Social",
      members: "300+",
    ...
    },
    {
      ...
      section: "kintl",
      brief:
        "International Students Society, uniting cultures from across the globe at KIIT.",
      category: "Cultural",
      members: "200+",
    ...
    },
    {
      ...
      section: "khwahishein",
      brief:
        "The official Hindi Society of KIIT, celebrating Hindi literature, music, and arts.",
      category: "Cultural",
      members: "300+",
    ...
    },
    {
      ...
      section: "kalakaar",
      brief:
        "The official Dramatic Society of KIIT, organizing plays, theater, and street performances.",
      category: "Drama",
      members: "400+",
    ...
    },
    {
      ...
      section: "konnexions",
      brief:
        "The Web Development & IT Society of KIIT, promoting coding and digital skills.",
      category: "Tech",
      members: "500+",
    ...
    },
    {
      ...
      section: "kconnect",
      brief:
        "The Alumni Connect Society, bridging students and KIIT alumni worldwide.",
      category: "Networking",
      members: "200+",
    ...
    },
    {
      ...
      section: "wordsmith",
      brief:
        "The Writing Society of KIIT, encouraging literature, blogs, and creative writing.",
      category: "Literature",
      members: "350+",
    ...
    },
    {
      ...
      section: "kzarshion",
      brief:
        "The official Fashion Society of KIIT, redefining style and creativity on campus.",
      category: "Fashion",
      members: "350+",
    ...
    },
    {
      ...
      section: "krayakuber",
      brief:
        "Marketing Society of KIIT, focusing on brand, strategy, and market awareness.",
      category: "Business",
      members: "300+",
    ...
    },
    {
      ...
      section: "kimaya",
      brief:
        "Medical Society of KIIT, spreading medical awareness and first aid training.",
      category: "Health",
      members: "300+",
    ...
    },
    {
      ...
      section: "civil",
      brief:
        "The Civil Engineering Society of KIIT for innovation in infrastructure and design.",
      category: "Engineering",
      members: "350+",
    ...
    },
    {
      ...
      section: "ncc",
      brief:
        "National Cadet Corps at KIIT, instilling discipline, unity, and leadership.",
      category: "Discipline",
      members: "200+",
    ...
    },
    {
      ...
      section: "nss",
      brief:
        "National Service Scheme at KIIT, focusing on community service and development.",
      category: "Social",
      members: "300+",
    ...
    },
    {
      ...
      section: "yrc",
      brief:
        "The Youth Red Cross KIIT chapter works for humanitarian service, social welfare, disaster relief, blood donation, and community health awareness.",
      category: "Social Service",
      members: "300+",
    ...
    },
    {
      ...
      section: "tedx-ku",
      brief:
        "The official TEDx Society of KIIT, organizing TEDx events to inspire ideas and innovation.",
      category: "Innovation",
      members: "200+",
    ...
    },
    {
      ...
      brief:
        "A society dedicated to animal welfare, wildlife conservation, and environmental protection.",
    ...
    },
    {
      ...
      brief:
        "A technical society focusing on electrical engineering innovations, workshops, and projects.",
      category: "Technical",
      members: "300+",
    ...
    },
    {
      ...
      section: "enactus",
      brief:
        "The Social Entrepreneurship Society of KIIT empowering students to create community impact.",
      category: "Entrepreneurship",
      members: "250+",
    ...
    },
    {
      ...
      section: "kraftovity",
      brief:
        "The official Art & Craft Society of KIIT, nurturing creativity through hands-on artistic activities.",
      category: "Art",
      members: "180+",
    ...
    },
    {
      ...
      section: "spic-macay",
      brief:
        "The Indian Classical Music and Culture Society promoting heritage through art and performances.",
      category: "Culture",
      members: "220+",
  ...
  useEffect(() => {
    const fetchSocietyEvents = async () => {
      try {
        ...
        const endpoint = HOSTED_URL ? `${HOSTED_URL}/api/kiit-societies` : "/api/kiit-societies";
        ...
        events.forEach((event: any) => {
          ...
          if (!societyKey) return;
          if (!groupedEvents[societyKey]) groupedEvents[societyKey] = [];
  ...
  // helper: only treat events with event_date strictly after today as upcoming
  const isFutureEvent = (ev: any) => {
    if (!ev || !ev.event_date) return false;
    return moment(ev.event_date).isAfter(moment(), "day");
  };

  useEffect(() => {
    // hash scrolling (client side)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-kiit-green-soft to-white">
      ...
      {/* Societies grid: simplified to map kiitSocieties if provided */}
          ...
          <div className="text-center mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {kiitSocieties.map((society, index) => {
                const key = society.name?.toLowerCase()?.trim();
                const eventsForSociety = (societyEvents[key] || []).filter(isFutureEvent).sort((a: any, b: any) => new Date(a.event_date).getTime() - new Date(b.event_date).getTime());
                const upcomingEvent = eventsForSociety[0] || null;

                return (
                  <div id={society.section} key={index} className="group relative overflow-hidden rounded-2xl transition-all duration-500 hover:scale-105 hover:shadow-2xl">
                    <div className={`relative h-80 bg-gradient-to-br ${society.gradient} p-6 text-white`}>
                      <div className="flex items-start justify-between mb-4">
                        <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-2xl border border-white/30">
                          {Societies[society.logoPlaceholder as keyof typeof Societies] ? (
                            <img src={Societies[society.logoPlaceholder as keyof typeof Societies]} alt={society.name} className="w-12 h-12 object-contain rounded-md" />
                          ) : (
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            if (society.instagram && society.instagram !== "#") window.open(society.instagram, "_blank");
                          }}
                      ...
                      <button onClick={() => society.website !== "#" && window.open(society.website, "_blank")} className="text-left w-full group/name">
                      ...
                      <div className="flex items-center gap-4 mb-4 text-sm">
                        <span className="px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">{society.category}</span>
                        <span className="flex items-center gap-1"><Users className="w-4 h-4" />{society.members}</span>
                      </div>

                      <button onClick={(e) => { e.stopPropagation(); if (society.website !== "#") window.open(society.website, "_blank"); }} className="w-full mb-4 p-3 bg-white/90 text-gray-800 rounded-xl border-2 border-yellow-300 shadow-lg hover:shadow-xl hover:bg-white transition-all duration-300 group/event">
                        <div className="flex items-center justify-between">
                          <div className="text-left">
                            <div className="font-semibold text-sm flex items-center gap-2"><Sparkles className="w-4 h-4 text-yellow-500" />{upcomingEvent ? "Upcoming Event" : "Next Event"}</div>
                            <div className="text-xs text-gray-600 mt-1">{upcomingEvent ? upcomingEvent.event_name : society.upcomingEvent?.date || "Events Coming Soon ..."}</div>
                          </div>
                          <div className="text-right">
                            <div className="text-xs font-medium text-orange-600">{upcomingEvent ? moment(upcomingEvent.event_date).format("MMM D, YYYY") : (society.upcomingEvent?.date || "TBA")}</div>
                    ...
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none" style={{ background: `linear-gradient(135deg, transparent 0%, rgba(255,255,255,0.3) 50%, transparent 100%)` }}></div>
                  </div>
                );
              })}
            </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-kiit-green-soft to-purple-100">
        <div className="container mx-auto text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-8">Stay updated with all society interviews, fest announcements, and sports events in one place.</p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Button className="bg-kiit-green hover:bg-kiit-green-dark text-white px-8 py-3" onClick={() => alert("Coming Soon! Interview tracker is under development.")}>Track Interviews</Button>
              <Button variant="outline" className="border-kiit-green text-kiit-green hover:bg-kiit-green hover:text-white px-8 py-3" onClick={() => router.push("/interview-deadlines-tracker")}>View All Events</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button className="rounded-full w-14 h-14 bg-green-500 hover:bg-green-600 text-white shadow-lg" onClick={() => window.open("https://wa.me/1234567890", "_blank")}>
